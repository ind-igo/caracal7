...
from caracal7.relations.ir import ENTRY, NONE, POINT, ACC, CHALS, KIND_PERM, KIND_LOOKUP, entry, shift_points, point_index, point_coord, residual_at, derived_chals, lookup_constant
